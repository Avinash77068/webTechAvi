...
import { Loader2, Mail, Phone, MapPin, MessageCircle, Calendar, Send } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <aside className="lg:col-span-1 space-y-6">
            ...
            <div className="glass rounded-xl p-5 border border-border/50 hover:border-primary/30 transition-colors">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${brandInfo.email}`} className="font-medium text-sm hover:text-primary transition-colors">
                    {brandInfo.email}
                  </a>
                </div>
              </div>
            ...
            <div className="glass rounded-xl p-5 border border-border/50 hover:border-primary/30 transition-colors">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`tel:${brandInfo.phonePrimary}`} className="font-medium text-sm hover:text-primary transition-colors">
            ...
            <div className="glass rounded-xl p-5 border border-border/50 hover:border-primary/30 transition-colors">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="font-medium text-sm">Noida, Uttar Pradesh, India</div>
                </div>
              </div>
            </div>
            ...
            <div className="glass rounded-xl p-5 border border-border/50">
              <div className="text-xs text-muted-foreground uppercase tracking-wide mb-4">PREFER SOMETHING FASTER?</div>
          ...
          <form onSubmit={onSubmit} className="lg:col-span-2 glass rounded-2xl p-8 border border-border/50 space-y-5">
